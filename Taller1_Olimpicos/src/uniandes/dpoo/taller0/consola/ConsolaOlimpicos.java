...
public class ConsolaOlimpicos
{
	...
	private void PaisMedallista() {
		String atleta = input("Ingrese el atleta que desea buscar: ");
		String pais = calculadora.PaisMedallista(atleta);
		if (pais != null) {
			System.out.println("El atleta " + atleta + "es del pais " + pais);
		}
		else {
			System.out.println("no se encontro el atleta con el nombre " + atleta);
